  ...
  return (
    <main className="min-h-screen bg-slate-50 dark:bg-slate-950 py-16">
      <div className="max-w-4xl mx-auto px-4">
        <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-2xl shadow-lg p-8 sm:p-12">
          <header className="mb-6 sm:mb-8">
            <h1 className="text-3xl sm:text-4xl font-extrabold text-slate-900 dark:text-white">Privacy Policy</h1>
            <p className="text-sm text-slate-500 dark:text-slate-400 mt-2">Thread Attachments for Gmail™</p>
            <p className="text-sm text-slate-500 dark:text-slate-400 mt-1"><strong>Effective date:</strong> December 29, 2025</p>
          </header>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none space-y-8">
            ...
            <section>
              ...
              <p>
                The Extension does not permanently store copies of your emails, message bodies, or attachment contents on any external server. It may temporarily cache metadata or identifiers in browser memory or extension storage solely to support the UI and user session; this data is not transmitted off the device and can be cleared by signing out, uninstalling the Extension, or clearing the Extension cache.
              </p>
            </section>
            ...
            <section>
              ...
              <p>If you have questions, concerns, or requests related to this Privacy Policy or your data, contact:<br />
                ...
                Email: <a className="text-google-blue hover:underline" href="mailto:roishmuel14@gmail.com">roishmuel14@gmail.com</a>
              </p>
            </section>
